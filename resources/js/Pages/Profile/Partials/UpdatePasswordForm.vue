...
<template>
    <section>
        <header>
            <h2 class="h4 fw-medium text-gray-900">Actualizar Contraseña</h2>
        ...
        <form @submit.prevent="updatePassword" class="mt-4">
            <div class="mb-3">
                ...
                <div class="invalid-feedback" v-if="form.errors.current_password">{{ form.errors.current_password }}</div>
            </div>
